...
export default function SiteFooter({ className = 'mt-10' }: SiteFooterProps) {
  return (
    <footer className={`${className} rounded-2xl border border-[hsl(220_16%_88%)] bg-[linear-gradient(180deg,hsl(220_28%_99%)_0%,hsl(220_20%_97%)_45%,hsl(220_18%_96%)_100%)] px-5 py-5 shadow-[0_10px_28px_rgb(18_32_74/0.08)]`}>
